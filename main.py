...
class Menu:
    def __init__(self):
        ...
        self.object_student_menu = StudentMenu()
        self.object_professor_menu = ProfessorMenu()
    ...
    def main_menu(self):
        while True:
            ...
            try:
                ...
                if (choice == 1):
                    self.object_professor_menu.professor_menu()
                
                
                elif (choice == 2):
                    self.object_student_menu.student_menu()
